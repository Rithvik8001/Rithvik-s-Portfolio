  ...
  return (
    <section className="px-6 lg:px-20 mx-auto max-w-[110rem] mt-16">
      ...
      <BlurFade delay={0.45} inView>
        <div className="max-w-4xl mx-auto space-y-4 mt-14">
          <p className="text-gray-700 text-xl">
            ...
            which laid a strong foundation for my frontend development skills.
            Over time, I have expanded my expertise to include modern frameworks
            and libraries such as React , also currently learning NextJs and
            Tailwind CSS .{" "}
          </p>
        </div>
      </BlurFade>
      <BlurFade delay={0.55} inView>
        <div className="max-w-4xl mx-auto space-y-4 mt-14">
          <p className="text-gray-700 text-xl">
            While I am not coding, I Love to watch Football⚽️. You can call me
            a football fanatic, I started watching this beautiful sport when I
            was 16 years old, and my favorite club is the biggest club in
      ...
      <BlurFade delay={0.65} inView>
        <div className="max-w-4xl mx-auto space-y-4 mt-14">
          <p className="text-gray-700 text-xl">
            ...
            web applications that solve real-world problems. I am excited about
            the opportunities in frontend development and look forward to
