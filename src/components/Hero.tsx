        ...
        <BlurFade delay={0.5} inView>
          <div className="flex flex-col lg:items-center gap-3">
            ...
            <div className="flex flex-wrap lg:justify-center">
              <h1 className="text-6xl lg:hidden lg:text-center lg:text-8xl xl:text-9xl w-fit font-bold max-w-3xl">
                <span className="text-c-violet">Frontend</span> Developer
              </h1>
              <AnimateLetter
                color="black"
                className="text-6xl text-c-violet hidden lg:block lg:text-center mr-10 lg:text-8xl xl:text-9xl w-fit font-bold max-w-3xl"
              >
                Frontend
              </AnimateLetter>
              <AnimateLetter className="text-6xl hidden lg:block lg:text-center lg:text-8xl xl:text-9xl w-fit font-bold max-w-3xl">
                Developer
              </AnimateLetter>
            </div>
            <BlurFade delay={0.25} inView>
