...
export default function Home() {
  return (
    <main className="min-h-[60vh]">
      ...
      <h3 className="md:text-7xl text-5xl px mt-20 md:text-center font-bold">About me<span className="text-c-violet">.</span></h3>
      ...
      <BlurFade delay={.5} inView>
        <h2 className="text-5xl md:text-7xl px-4 md:text-center mb-7 font-bold">Projects<span className="text-c-violet">.</span></h2>
        </BlurFade>
        <ProjectsPreview />
